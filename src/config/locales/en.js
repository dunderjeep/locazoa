...
const messages = defineMessages({
  ...
  size_label: 'Size',
  size_hint: 'Enter size',
  subscription_length_label: 'Subscription Length',
  subscription_length_hint: 'Enter subscription length',
  subscription_frequency_label: 'Subscription Frequency',
  subscription_frequency_hint: 'Enter subscription frequency',
  no_connection: 'No connection',
  delete_box_title: 'Delete box?',
  delete_box_message: 'The box will be deleted!',
  publish_box_dialog_title: 'Ready to Publish?',
  publish_box_dialog_message: 'This means making your box visible to all.',
  publish: 'Publish',
  save_draft_dialog_title: 'Save as Draft?',
  save_draft_dialog_message: 'This means making your box visible only to you.',
  save_draft: 'Save as Draft',
  delete_task_title: 'Delete task?',
  delete_task_message: 'The task will be deleted!',
  delete_post_title: 'Delete post?',
  delete_post_message: 'The post will be deleted!',
  error: 'Error!',
  companies: 'Companies',
